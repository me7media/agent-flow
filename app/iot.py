    ...
    return [
        {
            ...
            "iotSourceIds": ["PTZB648647BMZSB", "garden-motion-sensor"],
        },
        {
    ...
    return [
        {
            ...
            "category": "iot",
            "task": "Recognize an approved hand gesture from the Camera0 (PTZB648647BMZSB) camera and prepare a safe driveway gate open/close command.",
            "workspaceRoot": "./workspace",
            "loops": 1,
            "cron": "",
            "steps": [
                {"id": "iot-gate-1", "agentId": "iot-signal-agent", "note": "Read metadata from the Camera0 (PTZB648647BMZSB) camera source.", "loops": 1, "cron": "", "dependsOnPrevious": True, "iotSourceIds": ["PTZB648647BMZSB"]},
                {"id": "iot-gate-2", "agentId": "vision-gesture-agent", "note": "Detect gesture intent: open, close, stop or ignore. Include confidence.", "loops": 1, "cron": "", "dependsOnPrevious": True, "iotSourceIds": ["PTZB648647BMZSB"]},
                ...
                {"id": "iot-gate-4", "agentId": "iot-device-manager", "note": "Prepare driveway gate command and execute.", "loops": 1, "cron": "", "dependsOnPrevious": True, "iotActionIds": ["driveway-gate"], "iotDryRun": False},
            ],
        },
        {
